 ...
 * @private
 */
abstract class AbstractFamily<T extends {[K: string]: Component}> implements Family {
 ...
 *
 */
class CachedFamily<T extends {[k: string]: Component}> extends AbstractFamily <T>{
 ...
 * @private
 */
class NonCachedFamily<T extends {[k: string]: Component}> extends AbstractFamily<T> {
  get entities() {
 ...
 */
class FamilyBuilder<T extends {[k: string]: Component}> {
